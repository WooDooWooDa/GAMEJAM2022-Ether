...
public class ReadScript : MonoBehaviour
{
    ...
    private static readonly List<int> _femaleSpriteIndices = new List<int>() { 1, 2, 6, 10 };
    ...
    public string GetNpcDisplayName(string npcName, int spriteIndex)
    {
        ...
        {
            var displayName = _femaleSpriteIndices.Contains(spriteIndex) ? _femaleNames[UnityEngine.Random.Range(0, _femaleNames.Count - 1)] : _maleNames[UnityEngine.Random.Range(0, _maleNames.Count - 1)];
